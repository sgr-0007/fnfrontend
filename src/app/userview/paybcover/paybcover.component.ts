...
@Component({
  selector: 'app-paybcover',
  templateUrl: './paybcover.component.html',
  styleUrls: ['./paybcover.component.css']
})
export class PaybcoverComponent implements OnInit {
...
branchOnChange(cId: number){
  ...
  this.uurlString  = this.reportU+"PayBankCover?companyid="+this.daybookForDialog.companyid+"&fromdate="+frdate+"&todate="+todate+"&vid=0";

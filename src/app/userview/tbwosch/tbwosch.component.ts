...
@Component({
  selector: 'app-tbwosch',
  templateUrl: './tbwosch.component.html',
  styleUrls: ['./tbwosch.component.css']
})
export class TbwoschComponent implements OnInit {
...
branchOnChange(cId: number){
  ...
  this.uurlString  = this.reportU+"TbWithoutSch?companyid="+this.daybookForDialog.companyid+"&fromdate="+frdate+"&todate="+todate;

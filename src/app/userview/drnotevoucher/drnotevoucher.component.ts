...
@Component({
  selector: 'app-drnotevoucher',
  templateUrl: './drnotevoucher.component.html',
  styleUrls: ['./drnotevoucher.component.css'],
  styles: [`
...
export class DrnotevoucherComponent implements  OnInit ,ComponentCanDeactivate {
  ...
  //module
  module = GlobalConstants.drnotevoucher;
  ...
  ngOnInit(): void {
    ...
    localStorage.setItem('vtype', 'drnote')
  ...
  retrieveVouchertypes(): void {
    this.voucherservice.getVoucherTypes(7)
      .subscribe({
        next: (data) => {
...
if(this.newItDetails!=null){
  ...
  retrieveVouchers(): void {
    this.voucherservice.getAll(7, this.loginuid)
      .subscribe({
        next: (data) => {
          this.vouchers = data;
          console.log(data);

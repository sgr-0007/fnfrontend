...
@Component({
  selector: 'app-trailbalancereportview',
  templateUrl: './trailbalancereportview.component.html',
  styleUrls: ['./trailbalancereportview.component.css']
})
export class TrailbalancereportviewComponent implements OnInit {
  ...
  onSearch(){
    ...
    this.uurlString  = this.reportU+"TrailBalanceAccountGroupReportViewer?companyid="+this.daybookForDialog.companyid+"&fromdate="+frdate+"&todate="+todate;

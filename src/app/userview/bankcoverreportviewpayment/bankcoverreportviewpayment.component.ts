...
@Component({
  selector: 'app-bankcoverreportviewpayment',
  templateUrl: './bankcoverreportviewpayment.component.html',
  styleUrls: ['./bankcoverreportviewpayment.component.css']
}) 
export class BankcoverreportviewpaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.uurlString  = this.reportU+"PayBankCover?companyid=1&fromdate=2022-01-01&todate=2022-02-01&vid="+this.vid+"&type=A";

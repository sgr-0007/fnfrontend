...
@Component({
  selector: 'app-crnotevoucher',
  templateUrl: './crnotevoucher.component.html',
  styleUrls: ['./crnotevoucher.component.css'],
  styles: [`
...
export class CrnotevoucherComponent implements OnInit ,ComponentCanDeactivate {
  ...
  //module
  module = GlobalConstants.crnotevoucher;
  ...
  ngOnInit(): void {
    ...
    localStorage.setItem('vtype', 'crnote')
  ...
  retrieveVouchertypes(): void {
    this.voucherservice.getVoucherTypes(8)
      .subscribe({
        next: (data) => {
...
if(this.newItDetails!=null){
  ...
  retrieveVouchers(): void {
    this.voucherservice.getAll(8, this.loginuid)
      .subscribe({
        next: (data) => {
          this.vouchers = data;
          console.log(data);

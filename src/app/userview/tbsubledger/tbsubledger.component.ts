...
@Component({
  selector: 'app-tbsubledger',
  templateUrl: './tbsubledger.component.html',
  styleUrls: ['./tbsubledger.component.css']
})
export class TbsubledgerComponent implements OnInit {
...
branchOnChange(cId: number){
  ...
  this.uurlString  = this.reportU+"TbSubleger?companyid="+this.daybookForDialog.companyid+"&fromdate="+frdate+"&todate="+todate;

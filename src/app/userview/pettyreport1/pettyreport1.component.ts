...
@Component({
  selector: 'app-pettyreport1',
  templateUrl: './pettyreport1.component.html',
  styleUrls: ['./pettyreport1.component.css']
})
export class Pettyreport1Component implements OnInit {
  ...
  this.uurlString  = this.reportU+"Pettycash?companyid="+this.pcashdialog.companyid+"&fromdate="+frdate+"&todate="+todate+"&rep=2";

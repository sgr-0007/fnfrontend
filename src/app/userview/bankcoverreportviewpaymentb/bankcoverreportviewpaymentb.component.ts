...
@Component({
  selector: 'app-bankcoverreportviewpaymentb',
  templateUrl: './bankcoverreportviewpaymentb.component.html',
  styleUrls: ['./bankcoverreportviewpaymentb.component.css']
})
export class BankcoverreportviewpaymentbComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.uurlString  = this.reportU+"PayBankCover?companyid=1&fromdate=2022-01-01&todate=2022-02-01&vid="+this.vid+"&type=B";

...
@Component({
  selector: 'app-bsreport',
  templateUrl: './bsreport.component.html',
  styleUrls: ['./bsreport.component.css']
})
export class BsreportComponent implements OnInit {
  ...
  onSearch(){
    ...
    this.uurlString  = this.reportU+"Balancesheet?companyid="+this.daybookForDialog.companyid+"&fromdate="+frdate+"&todate="+todate;

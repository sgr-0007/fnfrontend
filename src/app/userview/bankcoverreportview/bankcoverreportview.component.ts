...
@Component({
  selector: 'app-bankcoverreportview',
  templateUrl: './bankcoverreportview.component.html',
  styleUrls: ['./bankcoverreportview.component.css']
})
export class BankcoverreportviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.uurlString  = this.reportU+"RecBankCover?companyid=1&fromdate=2022-01-01&todate=2022-02-01&vid="+this.vid;
